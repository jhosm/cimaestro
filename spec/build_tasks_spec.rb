...
describe ExecutionTimeTask do
  ...
  it "should count time" do
    @execution_time = ExecutionTimeTask.new SleepTask.new, BuildSpec.new("x","x")
    @execution_time.setup
    @execution_time.execute
    @execution_time.duration.should be_close(0.1, 0.01)
  end
  ...
  it "should count time, even if task throws" do
    ...
    @execution_time = ExecutionTimeTask.new task, BuildSpec.new("x","x")
    @execution_time.setup
